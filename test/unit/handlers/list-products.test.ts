...
await tap.test('calls findAllProducts', async function (t) {
  // Arrange
...
await tap.test('calls findProductById', async function (t) {
  // Arrange
...
await tap.test('calls findProductsByPattern', async function (t) {
  // Arrange
