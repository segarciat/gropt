...
await tap.test('calls findAllStores', async function (t) {
  // Arrange
...
await tap.test('calls findStoreById', async function (t) {
  // Arrange
...
await tap.test('calls findStoresByPattern', async function (t) {
  // Arrange
