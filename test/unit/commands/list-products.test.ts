...
tap.test('list products comand', async function (t) {
  let handlerSpy
  let command: Command
  ...
  tap.beforeEach(async function (t) {
    ...
    command = buildListProducts(mockDb as DBConnection, handlerSpy)
  })
  ...
  tap.test('call with --name-pattern option', async function (t) {
    // Arrange
  ...
  tap.test('--pattern-name and --brand-pattern is a valid combinations', async function(t) {
