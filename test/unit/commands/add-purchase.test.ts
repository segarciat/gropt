...
let handlerSpy: any
let addPurchaseCommand: Command
tap.beforeEach(async function (t) {
  ...
  const { buildAddPurchaseCommand } = await t.mockImport('../../../src/commands/add-purchase.js', {
    '../../../src/repositories/units.js': {
      getValidUnits: async (...args: any[]) => ['lb', 'oz']
    }
...
await tap.test('Parses options correctly and calls spy successfully', async function (t) {
  // Arrange
...
await tap.test('Throws when options given are incorrect', async function (t) {
